...
dd
  ...
  .gap-top
    base-checkbox(id="setting_list_showLocalFileCount_enable" :model-value="appSetting['list.showLocalFileCount']" :label="$t('setting__list_show_local_file_count')" @update:model-value="updateSetting({'list.showLocalFileCount': $event})")
